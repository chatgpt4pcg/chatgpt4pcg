 ...
 */
export function getBlocksWithPosition(functionsString: string, functionPrefix = 'drop_block('): [Array<Block>, Grid] {
  const blocks = [];
 ...
 */
function getBlockTypeFromLine(line: string, functionPrefix = 'drop_block('): BlockType {
